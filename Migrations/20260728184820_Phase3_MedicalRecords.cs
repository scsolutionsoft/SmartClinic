...
{
    /// <inheritdoc />
    public partial class Phase3_MedicalRecords : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpdFileName = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: false),
                    OpdContentType = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    OpdPdfData = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_ClinicCode_CitizenId",
                table: "Patients",
                columns: new[] { "ClinicCode", "CitizenId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentRecords_ClinicCode_PatientId_VisitDate",
